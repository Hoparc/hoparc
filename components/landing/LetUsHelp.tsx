  ...
  return (
    <div className="w-full flex flex-col gap-y-6 mx-auto my-12 max-w-screen-xl w-11/12 justify-around lg:flex-row items-center">
      <div className="flex flex-col items-center justify-center grow-0">
        <h2 className="font-roboto text-blue-550 text-5xl text-center w-full">Let us Help</h2>
        <Image
      ...
      <div className=" flex px-3 w-full lg:w-1/2 ">
        <p>
          <span className="flex justify-start text-5xl text-blue-350 italic">"</span>
          <span className="text-4xl italic text-blue-350">O</span>          ur Clinic believe in "your care is our goal" and we have an optimistic, dynamic, supervised active approach to rehabilitation. The physiotherapists at Hands on Physio use manual therapy techniques, Hot stone soft tissue release, Mobilization soft tissue release technique, different modalities, exercise programs which include assistive support exercising with supervised ex program and personalized home ex program, taping, education and the latest in modern therapy equipment in their approach to treatment.
          <span className="flex justify-end text-5xl text-blue-350 italic">"</span>
        </p>
      </div>
    </div>
  );
