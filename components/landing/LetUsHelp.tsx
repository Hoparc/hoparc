  ...
  return (
    <div className="w-full flex flex-col gap-y-6 mx-auto my-12 max-w-screen-xl justify-around lg:flex-row items-center">
      ...
      <div className=" flex px-3 w-full lg:w-1/2 ">
        <p>
          <span className="flex justify-start text-5xl text-blue-350 italic">
            "
          </span>
          <span className="text-4xl italic text-blue-350">O</span> ur Clinic
          ...
          <span className="flex justify-end text-5xl text-blue-350 italic">
            "
          </span>
        </p>
      </div>
