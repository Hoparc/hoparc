  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-150">
      ...
      <div className="mx-5 lg:mx-64 my-12 lg:my-24">
        ...
        <p className="mt-5">
          You may use the Site only for your own non-commercial personal use and
          in compliance with these Terms. You are responsible for your own
          ...
          communications to the Site. We require all Members to agree not to use
          the Site, and specifically prohibit any use of the Site, for any of
          the following purposes:
        </p>
        <br />
        <p>
          Posting, communicating or transmitting any material that infringes on
          any intellectual property, publicity or privacy right of another
          person or entity Posting any information which is untrue, inaccurate
          or not your own. Engaging in conduct that would constitute a criminal
        ...
        <p>
          ...
          Physiotherapy and Rehab Centre' network security, or attempting to use
          the Site's service to gain unauthorized access to any other computer
          system. You are responsible for maintaining the confidentiality of
          ...
          immediately notify us in the event of any unauthorized use of your
          account or other breach of security.
        </p>
        <br />

        <p>2. Additional Terms and Conditions</p>
        ...
        <p className="mt-5">
          ...
          and Rehab Centre for any reason (a “Member”). We reserve the right to
          revoke your membership for any reason at any time including as a
          result of a violation of these Terms of the Privacy Policy, without
          notice. Membership is void where prohibited by law. In order to redeem
          earnings from activities on the Site, you must A) have confirmed your
          email address by responding to any email sent to you from Klapta
          Research Services, AND B) completed a minimum of five (5) surveys that
          have all been validated by the client. .
        </p>
        <br />
        <p>
        ...
        <p>4. Product Information; Limitation on Quantities</p>
        <p className="mt-5">
          ...
          correct without liability. We also reserve the right to limit
        ...
        <p className="mt-5">
          ...
          modify or create derivative works from any content or materials on the
          Site. Hands On Physiotherapy and Rehab Centre and the Hands On
          Physiotherapy and Rehab Centre logo are registered trademarks of Hands
          On Physiotherapy and Rehab Centre All other trademarks are the
          property of their respective owners.
        </p>
        <br />

        <p>6. Submitted Content</p>
        <p className="mt-5">
          Hands On Physiotherapy and Rehab Centre does not claim ownership of
          any materials you make available through the Site. With respect to any
          materials you submit or make available for inclusion on the Site, you
          grant Hands On Physiotherapy and Rehab Centre a perpetual,
          irrevocable, non-terminable, worldwide, royalty-free and non-exclusive
          license to use, copy, distribute, publicly display, modify, create
          derivative works, and sublicense such materials or any part of such
          materials. You hereby represent, warrant and covenant that any
          materials you provide do not include anything(including, but not
          limited to, text, images, music or video) to which you do not have the
          full right to grant Hands On Physiotherapy and Rehab Centre the
          license specified above. You further represent, warrant and covenant
          that any materials you provide will not contain libelous or otherwise
          unlawful, abusive or obscene material. Hands On Physiotherapy and
          Rehab Centre will be entitled to use any content submitted by you
          without incurring obligations of confidentiality, attribution or
          compensation to you.
        </p>
        <br />
        ...
        <p className="mt-5">
          ...
          Site. THE SITE, AND ALL CONTENT, MERCHANDISE, AND OTHER INFORMATION ON
          OR ACCESSIBLE FROM OR THROUGH THIS SITE OR A “LINKED” SITE ARE
          PROVIDED ON AN “AS IS” AND “AS AVAILABLE” BASIS WITHOUT WARRANTY OF
          ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE
          IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
          PURPOSE, NONINFRINGEMENT, SECURITY OR ACCURACY. SPECIFICALLY, BUT
          WITHOUT LIMITATION, Hands On Physiotherapy and Rehab Centre DOES NOT
          WARRANT THAT:
          <p className="mt-5">
            (1) THE INFORMATION ON THIS SITE IS CORRECT, ACCURATE OR RELIABLE
          </p>
          <p>
            (2) THE FUNCTIONS CONTAINED ON THIS SITE WILL BE UNINTERRUPTED OR
            ERROR-FREE; OR
          </p>
          <p>
            (3) DEFECTS WILL BE CORRECTED, OR THAT THIS SITE OR THE SERVER THAT
        ...
        <p>
          ...
          to which you may be directed or hyperlinked from this Site. Hyperlinks
          are included solely for your convenience, and Hands On Physiotherapy
          and Rehab Centre makes no representations or warranties with regard to
          the accuracy, availability, suitability or safety of information
          provided in such non-Hands On Physiotherapy and Rehab Centre sites.
          Hands On Physiotherapy and Rehab Centre does not endorse, warrant or
          guarantee any products or services offered or provided by or on behalf
          of third parties on the Site.
        </p>
        <br />
        ...
        <p className="mt-5">
          ...
          these Terms or the Privacy Policy, content posted to the Site by you,
          or your violation of any law or the rights of a third party.
        </p>
        <br />
        <p>9. Limititation of Liability</p>
        <p className="mt-5">
          IN NO EVENT SHALL EPITOME RESEARCH SERVICES LLP , ITS AFFLIATES OR ANY
          ...
          BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, LOSS OF DATA, OR LOSS
          OF USE) ARISING OUT OF THE USE OR INABILITY TO USE THE SITE, WHETHER
          BASED UPON WARRANTY, CONTRACT, TORT, OR OTHERWISE, EVEN IF EPITOME
          RESEARCH SERVICES LLP HAS BEEN ADVISED OF OR SHOULD HAVE KNOWN OF THE
          POSSIBILITY OF SUCH DAMAGES OR LOSSES. IN NO EVENT SHALL THE TOTAL
          LIABILITY OF EPITOME RESEARCH SERVICES LLP , ITS AFFILIATES OR ANY OF
          ...
          ACTION RESULTING FROM YOUR USE OF THIS SITE, WHETHER IN CONTRACT, TORT
          (INCLUDING, BUT NOT LIMITED TO, NEGLIGENCE) OR OTHERWISE, EXCEED THE
          AMOUNT YOU PAID TO EPITOME RESEARCH SERVICES LLP IN CONNECTION WITH
          THE EVENT GIVING RISE TO SUCH LIABILITY.
        </p>
        <br />
        <p>
          You hereby acknowledge that the preceding paragraph shall apply to all
          ...
          exclusion or limitation of certain damages, all of the above
          disclaimers or exclusions may not apply to all users.
        </p>
        <br />

        <p>10. International Use</p>
        <p className="mt-5">
          ...
          for use outside the India. If you choose to access this Site from
          outside the India, you do so at your own initiative and are
        ...
        <p>12. Copyright Infringment; Notice and Take Down Procedures</p>
        <p className="mt-5">
          Hands On Physiotherapy and Rehab Centre specifically prohibits the
          posting of any content that violates or infringes the copyright rights
          and/or other intellectual property rights (including rights of privacy
          and publicity) of any person or entity. If you believe that any
          material contained on this Site infringes your copyright or other
          intellectual property rights, you should notify us of your copyright
        ...
        <address className="not-italic flex flex-col justify-center mt-4 ">
          <p>Hands on Physiotherapy and Rehab Centre</p>
          <p className="">338 Copper Creek Dr,</p>
          <p className="">Markham On L6B 1N8, Canada</p>
          <p>
            <a
              className="underline hover:text-green-350"
