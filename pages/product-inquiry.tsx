...
const ProductInquiry: NextPage<ProductInquiryProps> = ({
  ...
  const [userChoice, setUserChoice] = useState(productName ?? "");
  ...
  return (
    <>
      <NextSeo
        title="Product Inquiry - Hands on Physiotherapy and Rehab Centre"
        description="Learn more about Hands On Physiotherapy
        Rehab Centre & Pelvic Health."
        canonical="https://hoparc.com/product-inquiry"
        openGraph={{
          url: "https://hoparc.com/product-inquiry",
          title: "Product Inquiry - Hands on Physiotherapy and Rehab Centre",
          description: `Learn more about Hands On Physiotherapy
          Rehab Centre & Pelvic Health.`,
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content:
              "physiotherapy, physiotherapy, product inquiry, rehab centre, rehab,",
          },
          {
            name: "author",
